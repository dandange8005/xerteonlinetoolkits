> **Historical baseline, preserved on 21 September 2026.** This records the original migration proposal and later partial status edits. Its open questions, colours, version references and verification statements are not current instructions. See [current migration status](../../MIGRATION.md).
