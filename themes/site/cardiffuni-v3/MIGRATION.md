...
| Components | Rules, seven callout types, page chrome (footer, feedback tab, back-to-top, glossary tip), alerts, badges, progress bars and tables implemented; tabs, accordions, cards and the rest need migration |
