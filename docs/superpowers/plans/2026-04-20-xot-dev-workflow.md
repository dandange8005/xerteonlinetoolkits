# XOT Dev Workflow Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create `PROJECTS/XOT-DEV-WORKFLOW.md` — a single markdown document that serves as both a phased onboarding checklist and a platform reference for Xerte XOT template development.

**Architecture:** One markdown file with two top-level sections: a sequential phase checklist (Section 1) and a named-topic platform reference (Section 2). All content is extracted from existing I-Prehab project docs; no new technical content is invented.

**Tech Stack:** Markdown only. No code, no build step, no dependencies.

**Spec:** `docs/superpowers/specs/2026-04-20-xerte-workflow-design.md`
...
**Files:**
- Create: `PROJECTS/XOT-DEV-WORKFLOW.md`

- [ ] **Step 1: Create the file with header, scope note, and table of contents**

Create `PROJECTS/XOT-DEV-WORKFLOW.md` with this exact content:
...
Run: `ls PROJECTS/XOT-DEV-WORKFLOW.md`
Expected: file listed with no error.

---

### Task 2: Write Section 1 — Project Setup Checklist

**Files:**
- Modify: `PROJECTS/XOT-DEV-WORKFLOW.md`

- [ ] **Step 1: Append Section 1 header and Phase 1**

Append to `PROJECTS/XOT-DEV-WORKFLOW.md`:
...
### Task 3: Write Section 2 — Platform Reference

**Files:**
- Modify: `PROJECTS/XOT-DEV-WORKFLOW.md`

- [ ] **Step 1: Append Section 2 header and topics 1–2**
...
- [ ] **Step 4: Append topics 8–9 and close the file**
...
**Files:**
- Read: `PROJECTS/XOT-DEV-WORKFLOW.md`

- [ ] **Step 1: Read the complete file and verify against the spec**

Open `PROJECTS/XOT-DEV-WORKFLOW.md` and confirm:
- Scope note is present in the header (XOT only, Bootstrap excluded)
- Section 1 has exactly 4 phases, each with an entry condition and a checkbox task list
- Section 2 has exactly 9 named topics, each with a short explanation and at least one code block or table
- No placeholder text ("TBD", "TODO", "similar to above")
- Table of contents anchors match the actual heading text

- [ ] **Step 2: Commit**

```bash
git add PROJECTS/XOT-DEV-WORKFLOW.md
git commit -m "docs: add XOT dev workflow guide

Personal onboarding checklist and platform reference for Xerte XOT template projects. Covers four development phases and nine platform-specific topics extracted from the I-Prehab project.

Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
```

Expected: commit succeeds, `PROJECTS/XOT-DEV-WORKFLOW.md` appears in git log.
